"""Archived Email Butler v1 Streamlit entrypoint.

This script is preserved for historical reference and is not part of the
active Email Handler application. It depends on the deprecated `src.*`
package layout from the original prototype.
"""
...
from src.database.models import (
    BlackBookContact,
    EmailGenerationSession,
    EmailTemplate,
    ReportedRecord,
)
from src.database.session import get_engine, get_session_factory, init_database
...
# Ensure project root is importable when this archive file is executed manually.
...
def main():
    ...
    with st.container():
        ...
        with col1:
            st.markdown(
                "# <span class='gold-shimmer'>Email Butler</span> "
                "<span class='silver-shimmer' style='font-size: 0.6em;'>part of the SPEAR toolbelt</span>",
